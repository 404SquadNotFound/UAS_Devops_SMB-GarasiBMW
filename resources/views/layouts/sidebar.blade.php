...
<aside class="w-[280px] flex flex-col flex-shrink-0 min-h-screen shadow-sm">
    ...
    <nav class="flex-1 bg-bmw-light-bg p-[16px] space-y-[4px]">
        ...
        <a href="{{ route('beranda.index') }}"
            class="flex items-center gap-[14px] px-[16px] py-[12px] rounded-[10px] transition-all group
            ...
            <svg class="w-[22px] h-[22px] transition-colors
                {{ request()->is('beranda') || request()->routeIs('beranda.index')
                    ? 'text-bmw-blue'
                    : 'text-[#213F5C]/70 group-hover:text-bmw-blue' }}"
        ...
        {{-- Layanan Servis --}}
        <div class="pt-[4px]" x-data="{ open: {{ request()->is('pelanggan*', 'manajemen-servis*', 'antrian-pengerjaan*') ? 'true' : 'false' }} }">
            <button @click="open = !open"
                class="w-full flex items-center justify-between px-[16px] py-[12px] rounded-[10px] text-[#213F5C] font-bold">
                <div class="flex items-center gap-[14px]">
                    <svg class="w-[22px] h-[22px] {{ request()->is('pelanggan*', 'manajemen-servis*', 'antrian-pengerjaan*') ? 'text-bmw-blue' : 'text-[#213F5C]/70' }}" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
