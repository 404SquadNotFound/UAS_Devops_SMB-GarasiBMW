            ...
            <div class="grid grid-cols-3 gap-6">
                ...
                <div class="bg-white border border-[#E5E9F2] rounded-[18px] p-6 flex flex-col gap-4 shadow-sm">
                    ...
                    <div class="space-y-3" id="metodePembayaranList">
                        ...
                        <div class="payment-method-card" data-metode="{{ $metode }}" onclick="selectMetode('{{ $metode }}')">
                            <span>{{ $metode }}</span>
                ...
                <div class="bg-white border border-[#E5E9F2] rounded-[18px] p-6 flex flex-col gap-4 shadow-sm">
                    ...
                    <div class="space-y-2.5 py-2 border-t border-b border-gray-100">
                        ...
                        <div id="ringkasanJasaRow" class="hidden flex justify-between items-center">
                            <span class="text-[13px] text-gray-500">Jasa Service (<span id="ringkasanJasaCount">0</span> item)</span>
...
<script>
    ...
    function handleCetakNota() {
        ...
        // Simpan data ke sessionStorage untuk halaman nota
        ...
        // Buka jendela cetak / navigasi ke halaman nota
        // Untuk sekarang: tampilkan konfirmasi sukses lalu redirect ke index
        Swal.fire({
            icon             : 'success',
            title            : 'Pembayaran Berhasil!',
            html             : `
                <div style="text-align:left; font-size:13px; color:#374151; line-height:1.8">
                    <b>Metode:</b> ${escHtml(selectedMetode)}<br>
                    <b>Jasa Service:</b> ${jasaList.length} item (${formatRupiah(totalJasa)})<br>
                    <b>Suku Cadang:</b> ${formatRupiah(totalSukuCadang)}<br>
                    <hr style="margin:8px 0; border-color:#E5E9F2">
                    <b style="font-size:15px; color:#16A34A">Total: ${formatRupiah(totalAll)}</b>
                </div>`,
