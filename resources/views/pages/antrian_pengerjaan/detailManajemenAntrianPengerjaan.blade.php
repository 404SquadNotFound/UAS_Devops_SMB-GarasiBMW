...
<div id="modalPembayaran"
    class="fixed inset-0 z-[998] items-center justify-center hidden"
                ...
                <div class="bg-white border border-[#E5E9F2] rounded-[18px] p-5 flex flex-col gap-4 shadow-sm">
                    ...
                    <div id="mpJasaSection" class="hidden space-y-3">
                        <div class="flex items-center justify-between border-t border-gray-100 pt-3">
                            ...
                            <span id="mpJasaBadge" class="px-2 py-0.5 bg-[#1273EB] text-white text-[11px] font-bold rounded-full">0</span>
                        </div>
...
<script>
    ...
    function mpHandleCetak() {
        ...
        window.location.href = `/antrian-pengerjaan/${id}/preview-nota`;
    }
